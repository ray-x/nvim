return {
  config = function()
    ...
    elseif exist('deno') then -- js/ts/md
    ...
    return {
      ...
      root_dir = require('lspconfig').util.root_pattern('.null-ls-root', 'Makefile', '.git', 'go.mod', 'package.json', 'requirements.txt', 'tsconfig.json'),
      ...
      on_attach = function(client, bufnr)
        if client.server_capabilities.documentFormattingProvider then
          local group = vim.api.nvim_create_augroup('NullLsFormatOnSave', { clear = false })
