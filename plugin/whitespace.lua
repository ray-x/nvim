-- Note: this file copy form glepnir/nvim
-- https://github.com/glepnir/nvim/blob/main/plugin/trimwhite.lua
...
vim.api.nvim_create_user_command("TrimSpace", trim_space, opts)
vim.api.nvim_create_user_command("PreviewSpace", function() trim_space() end, opts)
